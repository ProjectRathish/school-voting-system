...
const PublicResultsDisplay = () => {
  ...
  if (data && data.show_results === false) {
    return (
      <Box sx={{
        display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center',
        minHeight: '100vh',
        ...
        >
          <Paper sx={{
            ...
            <Box sx={{ position: 'relative', display: 'inline-flex' }}>
              ...
              >
                <RefreshCw size={36} style={{ color: 'white', animation: 'spin 4s linear infinite' }} />
              </Avatar>
            </Box>

            <Box>
              <Typography variant="caption" sx={{
                color: '#818cf8', fontWeight: 700, letterSpacing: '2px', textTransform: 'uppercase', display: 'block', mb: 1
              }}>
                {data.school_name || 'Official Election'}
              </Typography>
              <Typography variant="h4" sx={{
                fontFamily: 'Outfit', fontWeight: 800, color: 'white', mb: 1,
              ...
              <Typography variant="subtitle1" color="text.secondary" sx={{ fontWeight: 500, opacity: 0.9 }}>
                Results Status: <span style={{ color: '#fbbf24', fontWeight: 700 }}>AWAITING RELEASE</span>
              </Typography>
            </Box>
            ...
            <Box>
              ...
              <Typography variant="body2" sx={{ color: '#94a3b8', lineHeight: 1.6, maxWidth: 400, mx: 'auto' }}>
                The detailed analytics dashboard announcement is currently pending. They will be shared on this screen once released by the election authority.
              </Typography>
            </Box>
